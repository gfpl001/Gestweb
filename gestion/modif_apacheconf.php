<?php // -- Script par IDEALOGEEK --
  $fichier_affichage = shell_exec("echo cat /etc/apache2/apache2.conf >> /var/www/gestion/script.sh");
...
<center><h2>Affichage du fichier de configuration "apache2.conf"</h2></center>
